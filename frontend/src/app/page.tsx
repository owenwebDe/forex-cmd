...
const features = [
  {
    ...
    description: "Professional MT5 platform with advanced charting and analysis tools",
  },
  {
    icon: Shield,
    title: "Secure & Regulated",
    description: "Bank-level security with regulatory compliance and fund protection",
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    description: "Access to forex, commodities, indices, and cryptocurrency markets",
  },
]
...
const testimonials = [
  {
    ...
    content: "The platform's execution speed and reliability have significantly improved my trading performance.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    role: "Investment Manager",
    content: "Excellent customer support and comprehensive trading tools. Highly recommended for serious traders.",
    rating: 5,
  },
  {
    name: "Emma Rodriguez",
    role: "Day Trader",
    content: "User-friendly interface with powerful features. Perfect for both beginners and experienced traders.",
    rating: 5,
  },
]
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-blue-600">MT5 CRM</h1>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              ...
              <span className="text-blue-600 block">MT5 Platform</span>
            </motion.h1>
            ...
            >
              Access global financial markets with our professional trading platform. Advanced tools, competitive
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the next generation of online trading with cutting-edge technology and professional-grade
              tools.
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join our platform today and experience professional trading with competitive conditions.
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-blue-400 mb-4">MT5 CRM</h3>
              <p className="text-gray-400">
                Professional trading platform with advanced MT5 integration and institutional-grade infrastructure.
              </p>
            </div>
            <div>
